...
st.subheader('Ingeniería predictiva TAQUÍA GUTIÉRREZ::Predicción Multi Modelo')
...
st.sidebar.subheader('Parámetros de las propiedades')
# Sidebar Options:
params={
'bedrooms' : st.sidebar.selectbox('Cuartos',(1,2,3,4,5)),
'bathrooms' : st.sidebar.selectbox('Baños',(1,1.5,2,2.5,3,3.5,4,4.5,5)),
'floors' : st.sidebar.selectbox('Cantidad de pisos',(df['floors'].unique())),
'sqft' : st.sidebar.slider('Metros cuadrados', 800,max(df['sqft_living']),step=100),
